...
var Textbox = function (_React$Component) {
    inherits(Textbox, _React$Component);

    function Textbox(props) {
        classCallCheck(this, Textbox);

        var _this = possibleConstructorReturn(this, (Textbox.__proto__ || Object.getPrototypeOf(Textbox)).call(this, props));
...
var App = function (_React$Component) {
    ...
    createClass(App, [{
        ...
        value: function render() {
            ...
            var validateColor = function validateColor(colorString) {
            ...
            return react.createElement(
                ...
                react.createElement(Textbox, { placeholder: "Please select a color", onInputChanged: this.onColorChanged, validation: validateColor }),
                react.createElement('bgcolor', { style: { backgroundColor: this._getCssColor(color) } }),
        ...
        key: '_parseStringToRgba',
        value: function _parseStringToRgba(hex) {
            if (hex[0] == "#") {
                hex = hex.substr(1);
            }
        ...
        key: '_getCssColor',
        value: function _getCssColor(hex) {
...
document.addEventListener('DOMContentLoaded', function () {
    reactDom.render(react.createElement(App, null), document.body.querySelector("#root"));
});
